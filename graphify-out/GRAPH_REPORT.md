...
## Corpus Check
- 65 files · ~60,896 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 346 nodes · 556 edges · 20 communities detected
...
Cohesion: 0.08
Nodes (14): createScope(), hashRequestBody(), normalizeIdempotencyKey(), PlanningIdempotencyService, stableStringify(), addSeconds(), getAuditKey(), getIdempotencyKey() (+6 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (19): createSnapshot(), createBlockedDocument(), createFallbackDocument(), createGenerationBaseValidation(), getBlockedReason(), PlanningMermaidGeneratorService, createSnapshot(), createSnapshot() (+11 more)
...
Cohesion: 0.16
Nodes (14): defaultCodeForStatus(), HttpExceptionFilter, normalizeHttpExceptionBody(), correctMermaidSyntax(), createRenderedDocument(), ensureMermaidInitialized(), getErrorMessage(), renderMermaidDocument() (+6 more)

### Community 6 - "Community 6"
Cohesion: 0.22
Nodes (16): buildListEdges(), buildListNodes(), buildRecoveryEdges(), buildRecoveryNodes(), createEdge(), createGeneratedDocument(), createMermaidDraft(), createNode() (+8 more)
...
Cohesion: 0.47
Nodes (3): PlanningAuditService, redactSummary(), redactValidation()
...
- **Thin community `Community 11`** (8 nodes): `planning.controller.ts`, `PlanningController`, `.analyzePlanningSession()`, `.constructor()`, `.createPlanningSession()`, `.generateMermaid()`, `.getPlanningSession()`, `.validateMermaid()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 16`** (6 nodes): `planning.ai-client.ts`, `OpenAIPlanningAiClient`, `.constructor()`, `.extractPlanningLogic()`, `PlanningAiClientUnavailableError`, `.constructor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (2 nodes): `AppModule`, `app.module.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (2 nodes): `planning.module.ts`, `PlanningModule`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `createPassedReport()` connect `Community 1` to `Community 2`, `Community 4`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `getErrorMessage()` connect `Community 5` to `Community 1`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `createSuccessEnvelope()` connect `Community 2` to `Community 1`, `Community 5`?**
